    ...
    <Container text>
      ...
      <List bulleted>
        ...
        <List.Item><a href="https://iextrading.com/developer/" target="_blank" rel="noopener noreferrer">IEX Developer
          Platform (stocks)</a></List.Item>
        <List.Item>A bleeding edge, disruptive algorithm for parsing data (<a
        ...
        <List.Item>Hosted on GitHub pages with CI/CD through Circle CI</List.Item>
      </List>
      ...
      <List>
        ...
        <List.Item>
          <List.Content>
            ...
            <List.Description>Currently Investopedia runs trades after a ~15 minute wait time. I wanted to add a tracker that would let the user know how much time
            was left in their trade and automatically update their portfolio once it had been completed. The user would have to manually add the trade here, but
            could click on a link with query params to open up the Investopedia page with pre-filled values.<br/>
              e.g. <code>https://www.investopedia.com/simulator/trade/tradestock.aspx?too=2&Sym=TRVG&Qty=4500</code> would sell 4500 shares of Trivago (TRVG).</List.Description>
          </List.Content>
        </List.Item>
      </List>
    </Container>
